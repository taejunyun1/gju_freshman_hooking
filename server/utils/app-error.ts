...
const publicMessages: Record<AppErrorCode, string> = {
  ...
  ASSESSMENT_IDEMPOTENCY_CONFLICT: '같은 제출 요청의 평가 내용이 달라졌습니다. 평가를 다시 시작해 주세요.',
  ...
  ROSTER_INVALID: '명단 입력값을 다시 확인해 주세요.',
  ROSTER_CONFLICT: '명단이 이미 변경되었습니다. 최신 내용을 확인해 주세요.',
...
const statusCodes: Record<AppErrorCode, number> = {
  ...
  ASSESSMENT_IDEMPOTENCY_CONFLICT: 409,
