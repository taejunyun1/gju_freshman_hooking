...
type Response = Awaited<ReturnType<Service['assessments']>>
type Dependencies = {
  exports: Pick<Service, 'assessments'>
...
export const createAdminExportAssessmentsHandler = (dependencies: Dependencies) => async (
  event: unknown,
  ...
  try {
    ...
    return { data: await dependencies.exports.assessments(jobId, cursor, { adminUserId: admin.userId }), requestId }
  }
  catch (error) {
...
export default defineEventHandler(event => createAdminExportAssessmentsHandler({
