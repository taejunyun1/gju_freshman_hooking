...
type Response = Awaited<ReturnType<ResourcesService['publish']>>
type Dependencies = {
  resources: Pick<ResourcesService, 'publish'>
...
export const createPublishAdminResourceHandler = (dependencies: Dependencies) => async (
  event: unknown,
  ...
  try {
    ...
    return {
      data: await dependencies.resources.publish(
        id,
...
export default defineEventHandler(event => createPublishAdminResourceHandler({
